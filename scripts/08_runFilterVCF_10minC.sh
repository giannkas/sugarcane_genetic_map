...
${JAVA} -jar ${NGSEP} FilterVCF -d 5 -q 40 -s -fi -minI 95 -minC 10 -minMAF 0.15 -minOH 0.1 -maxOH 0.8 ${VCF_in} 1> ${save_location}filtervcf.95ids.lastline_filtered_10minC.vcf 2> ${save_location}filtervcf.95ids.lastline_filtered_10minC.log;
