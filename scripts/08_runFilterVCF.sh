...
${JAVA} -jar ${NGSEP} FilterVCF -d 5 -q 40 -s -fi -minI 95 -minC 20 -minMAF 0.15 -minOH 0.1 -maxOH 0.8 ${VCF_in} 1> ${save_location}filtervcf.95ids.lastline_filtered.vcf 2> ${save_location}filtervcf.95ids.lastline_filtered.log;
